...
class MountainCarLatentConditionalFlowMatcher(BaseFlowMatcher):
    ...
    def load_from_checkpoint(cls, checkpoint_path: str, device: Optional[str] = None):
        ...
        from adaptive_roa.systems.mountain_car import MountainCarSystem
        from adaptive_roa.model.mountain_car_unet import MountainCarUNet
        ...
        if system is None:
            ...
            if hydra_config and "system" in hydra_config:
                ...
                system = MountainCarSystem(dataset_dir=dataset_dir)
            else:
