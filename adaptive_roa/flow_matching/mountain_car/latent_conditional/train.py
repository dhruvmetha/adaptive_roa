#!/usr/bin/env python3
"""
Training script for Mountain Car Latent Conditional Flow Matching (Facebook FM)

Uses Hydra target instantiation for clean, config-driven architecture.

Usage:
    # Train Mountain Car
    python adaptive_roa/flow_matching/mountain_car/latent_conditional/train.py
...
@hydra.main(version_base=None, config_path="../../../../configs", config_name="train_mountain_car")
def main(cfg: DictConfig):
    """
    Training for Mountain Car Latent Conditional Flow Matching using Hydra instantiation
    ...
    # Print configuration
    print("="*80)
    print("🚀 Mountain Car Latent Conditional Flow Matching Training (Facebook FM)")
    print("="*80)
    print(f"📋 Config: {cfg.get('name', 'mountain_car_latent_conditional_fm')}")
