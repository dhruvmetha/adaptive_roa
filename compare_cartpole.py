#!/usr/bin/env python3
"""Compare evaluation metrics across adaptive sampling strategies for CartPole."""
...
RUNS = [
    {
        ...
        "base": (
            "/common/users/shared/pracsys/adaptive_roa_experiments/dhruv/adaptive_cartpole_pybullet/outputs/"
            "training_index_0_d2_ratio_0.0_warm_start_False_manifold_False_threshold_mode_dynamic_adapt_iter_20_alpha_0.1_sampling_mode_ranked_w_0.9/"
            "2026-02-18_14-26-34"
        ),
        "color": "blue",
        "marker": "o",
    ...
    },
    {
        ...
        "base": (
            "/common/users/shared/pracsys/adaptive_roa_experiments/dhruv/adaptive_cartpole_pybullet/outputs/"
            "training_index_0_d2_ratio_1.0_warm_start_False_manifold_False_threshold_mode_dynamic_adapt_iter_20_alpha_0.1_sampling_mode_direct_w_0.9/"
            "2026-02-18_14-26-32"
        ),
        "color": "red",
        "marker": "s",
    ...
    },
    {
        ...
        "base": (
            "/common/users/shared/pracsys/adaptive_roa_experiments/dhruv/adaptive_cartpole_pybullet/outputs/"
            "training_index_0_d2_ratio_1.0_warm_start_False_manifold_False_threshold_mode_dynamic_adapt_iter_20_alpha_0.1_sampling_mode_ranked_w_0.9/"
            "2026-02-18_14-26-32"
        ),
        "color": "green",
        "marker": "^",
...
EVAL_SUBDIR = "evaluations/radius_0.2_alpha_0.1_mc_10_batch_100000"
OUTPUT_PATH = "/common/home/dm1487/robotics_research/tripods/olympics-classifier/cartpole_comparison.pdf"


def load_run_data(base_path, eval_subdir, n_epochs):
    data = {
...
def main():
    ...
    for run in RUNS:
        ...
        d = load_run_data(run["base"], EVAL_SUBDIR, run["n_epochs"])
        run_data.append(d)
    ...
    fig.suptitle("CartPole: Sampling Strategy Comparison", fontsize=16, fontweight="bold", y=0.99)
