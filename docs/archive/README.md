...
| `AMAREL_GUIDE.md` (+`.pdf`) | A generic Amarel/SLURM tutorial of placeholders. This repo's evidence (`rlab3`, `gpu:4500_ada`, `/common/home/dm1487`) points at iLab, not Amarel. Real SLURM entry point: `scripts/sbatch_run.sh` |
