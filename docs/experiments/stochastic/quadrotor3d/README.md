...
### quad3D `corridor_sine_ambient f_0.30` — 27/252 epochs, 0/14 arms complete

_Only 0/3 uniform floor seeds have rows (none), so no 2·SD floor is computable yet. Per-arm depth: `clf_dir00` 5, `clf_epi_bald` 3, `clf_epi_var` 3, `clf_epi_var_anch` 3, `clf_yield` 2, `partx` 11._
