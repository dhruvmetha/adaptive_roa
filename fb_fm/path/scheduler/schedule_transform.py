...
from fb_fm.path.scheduler.scheduler import Scheduler
...
class ScheduleTransformedModel(ModelWrapper):
    ...
    .. code-block:: python
        ...
        import torch
        from fb_fm.path.scheduler import CondOTScheduler, CosineScheduler, ScheduleTransformedModel
        from fb_fm.solver import ODESolver
