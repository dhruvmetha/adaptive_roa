#!/usr/bin/env python3
"""
Re-evaluate CartPole models from all epochs with configurable parameters.
...
from run_adaptive_cartpole import evaluate_full_roa_fast
...
def load_checkpoint(epoch_dir: Path, device: str):
    ...
    return CartPoleLatentConditionalFlowMatcher.load_from_checkpoint(
...
def recompute_qhat(
    ...
    # CartPole uses two_sided decision rule
...
def main():
    parser = argparse.ArgumentParser(
        description="Re-evaluate CartPole models with configurable parameters"
    )
    parser.add_argument(
        "training_dir",
        type=Path,
    ...
    # RE-EVALUATION MODE
    print("=" * 70)
    print("RE-EVALUATION MODE - CartPole")
    print("=" * 70)
