...
Usage:
    python adaptive_roa/adaptive/run_adaptive_cartpole.py
    python adaptive_roa/adaptive/run_adaptive_cartpole.py --config-name=adaptive_cartpole_pybullet
"""
import os
import hydra
...
def compute_metrics_lambda_only_cartpole(
    p_success: np.ndarray,
    p_failure: np.ndarray,
    y_all: np.ndarray,
    lambda_star: float,
    ...
    Decision rule (two-sided for CartPole):
...
def evaluate_full_roa_fast(
    ...
    metrics_lambda_only = compute_metrics_lambda_only_cartpole(
        p_success=p_success,
        p_failure=p_failure,
        y_all=y_all,
        lambda_star=lambda_star,
