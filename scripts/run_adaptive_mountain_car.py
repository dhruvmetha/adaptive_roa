...
Usage:
    ...
    python adaptive_roa/adaptive/run_adaptive_mountain_car.py --config-name=adaptive_mountain_car
"""
import os
import hydra
...
from adaptive_roa.data.mountain_car_endpoint_data import MountainCarEndpointDataModule
...
def train_flow_matcher(
    ...
    data_module = MountainCarEndpointDataModule(
        ...
        dataset_dir=cfg.system.get('dataset_dir'),
    )
