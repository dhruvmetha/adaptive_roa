...
@hydra.main(config_path="../configs", config_name="build_sampled_endpoint_dataset.yaml")
def main(cfg: DictConfig) -> None:
    ...
    all_trajectory_files = list(data_dirs.glob("*.txt"))
    
    sample_points = cfg.sample_points
    
    trajectory_files = np.random.choice(all_trajectory_files, sample_points, replace=False)
    ...
    output_file = dest_dir / f"{sample_points}_endpoint_dataset.txt"
