"""
Inference wrapper for CartPole Gaussian Noise Flow Matching
...
class CartPoleGaussianNoiseInference:
    """
    ...
    Usage:
        ...
        inferencer = CartPoleGaussianNoiseInference(
            "outputs/cartpole_gaussian_noise_fm/2025-10-17_12-30-45"
        )
    ...
    def __init__(self, checkpoint_path: Union[str, Path], device: Optional[str] = None):
        ...
        self.model = CartPoleGaussianNoiseFlowMatcher.load_from_checkpoint(
            checkpoint_path,
            device=self.device
        )
