#!/usr/bin/env python3
"""
Training script for CartPole Gaussian Noise Flow Matching
...
from src.flow_matching.cartpole.gaussian_noise.flow_matcher import CartPoleGaussianNoiseFlowMatcher


@hydra.main(version_base=None, config_path="../../../../configs", config_name="train_cartpole_gaussian_noise")
def main(cfg: DictConfig):
    """
    Main training function for Gaussian Noise Flow Matching
    ...
    print("="*80)
    print("🚀 CartPole Gaussian Noise Flow Matching Training")
    print("="*80)
    print("\n📋 Configuration:")
    ...
    flow_matcher = CartPoleGaussianNoiseFlowMatcher(
        system=system,
        model=model,
