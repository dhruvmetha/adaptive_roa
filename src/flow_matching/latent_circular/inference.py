"""
Latent Circular Flow Matching inference with endpoint sampling
"""
import torch
...
class LatentCircularInference:
    """
    Inference class for Latent Circular Flow Matching
    
    Provides endpoint sampling by integrating the learned flow field
    conditioned on latent variables z ~ N(0,I).
    """
    ...
    def sample_endpoints(self, x0: Tensor, num_samples: int = 32) -> Tensor:
        """
        Sample multiple endpoints from the learned distribution p(y|x₀)
        ...
        # Sample latent variables z ~ N(0, I)
