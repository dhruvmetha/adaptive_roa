#!/usr/bin/env python3
"""
Training script for Pendulum Gaussian Noise Flow Matching
...
@hydra.main(version_base=None, config_path="../../../../configs", config_name="train_pendulum_gaussian_noise")
def main(cfg: DictConfig):
    ...
    print("="*80)
    print("🚀 Pendulum Gaussian Noise Flow Matching Training")
    print("="*80)
    print("\n📋 Configuration:")
    ...
    flow_matcher = PendulumGaussianNoiseFlowMatcher(
        system=system,
        model=model,
