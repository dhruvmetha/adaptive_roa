...
class HumanoidUNet(nn.Module):
    """
    Humanoid UNet for Conditional Flow Matching:
    - Takes embedded humanoid state x_t (67D), time t, condition
    ...
    def forward(self,
        ...
        """
        Forward pass for Humanoid Conditional Flow Matching
    ...
    def get_model_info(self) -> dict:
        ...
        return {
            ...
            "model_type": "Humanoid Conditional Flow Matching"
        }
